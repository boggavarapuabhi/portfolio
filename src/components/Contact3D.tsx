    ...
    <section id="contact" className="relative py-28 px-6" ref={ref}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          >
            <TiltCard className="card p-8 h-full" intensity={5}>
              ...
              <div className="space-y-5">
                <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-4 group">
                  ...
                  <div>
                    <span className="text-xs text-dim block">Email</span>
                    <span className="text-white/80 group-hover:text-accent transition-colors text-sm">
                      {siteConfig.email}
                    </span>
                  </div>
                </a>
                ...
                <a href={`tel:${siteConfig.phone}`} className="flex items-center gap-4 group">
                  ...
                  <div>
                    <span className="text-xs text-dim block">Phone</span>
                    <span className="text-white/80 group-hover:text-accent transition-colors text-sm">
                      {siteConfig.phone}
                    </span>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="text-xs text-dim block">Location</span>
                    <span className="text-white/80 text-sm">{siteConfig.location}</span>
                  </div>
                </div>
                ...
                <div className="pt-4 mt-4 border-t border-card-border">
                  <div className="flex gap-3">
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-white/[0.04] flex items-center justify-center text-muted hover:text-white hover:bg-white/[0.08] transition-all"
                    >
          ...
          <div className="space-y-6">
            ...
            >
              <TiltCard className="card p-8" intensity={5}>
            ...
            >
              <TiltCard className="card p-8" intensity={5}>
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-accent text-white text-sm font-medium hover:bg-accent-soft transition-colors"
                >

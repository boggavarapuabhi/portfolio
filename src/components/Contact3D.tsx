    ...
    <section id="contact" className="relative py-28 px-6" ref={ref}>
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-16">
          ...
          >
            <TiltCard className="card p-8 h-full" intensity={6}>
              ...
              <div className="space-y-5">
                <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-4 group">
                  <div className="w-10 h-10 rounded-xl bg-surface flex items-center justify-center text-foreground/60 group-hover:bg-surface-hover transition-colors">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
                    </svg>
                  </div>
                  <div>
                    <span className="text-xs text-tertiary block">Email</span>
                ...
                <a href={`tel:${siteConfig.phone}`} className="flex items-center gap-4 group">
                  ...
                  <div>
                    <span className="text-xs text-tertiary block">Phone</span>
                    <span className="text-foreground/80 group-hover:text-foreground transition-colors text-sm">
                      {siteConfig.phone}
                    </span>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-xl bg-surface flex items-center justify-center text-foreground/60">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    <span className="text-xs text-tertiary block">Location</span>
                    <span className="text-foreground/80 text-sm">{siteConfig.location}</span>
                  </div>
                </div>
                ...
                <div className="pt-4 mt-4 border-t border-border">
                  <div className="flex gap-3">
                    <a
                      ...
                      className="w-10 h-10 rounded-xl bg-surface flex items-center justify-center text-secondary hover:text-foreground hover:bg-surface-hover transition-all"
                    >
        ...
        >
          ...
          <p className="text-tertiary/50 text-xs mt-1">

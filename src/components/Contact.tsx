    ...
    <section id="contact" className="py-24 md:py-40 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative">
        ...
        >
          ...
          <h2 className="text-sm font-mono text-accent mb-6 uppercase tracking-[0.2em]">
            Let&apos;s Connect
          </h2>
          ...
          <p className="text-muted text-lg md:text-xl mb-14 max-w-2xl mx-auto leading-relaxed">
            ...
            combine engineering depth with business analytics. If you&apos;re
            looking for someone who ships fast and thinks deeply —{" "}
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5 mb-20">
            <motion.a
              ...
              className="group inline-flex items-center gap-3 bg-accent hover:bg-accent-light text-white px-10 py-5 rounded-2xl font-medium text-lg transition-all duration-300 shadow-xl shadow-accent/20 hover:shadow-accent/30"
            >
              <Mail size={22} />
              Send me an email
              ...
              return (
                <motion.div key={item.label} whileHover={{ y: -2 }}>
                  <Tag
                    ...
                    className="p-4 rounded-2xl border border-border bg-card/50 backdrop-blur-sm hover:bg-card-hover transition-all duration-300 flex items-center gap-3 justify-center cursor-pointer"
                  >

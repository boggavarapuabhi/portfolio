...
function ProjectCard({
  ...
  return (
    ...
    >
      <TiltCard className="card overflow-hidden" intensity={5}>
        {/* Top accent line */}
        ...
        <div className="p-8">
          ...
          <div className="flex items-start justify-between mb-6 flex-wrap gap-3">
            <div>
              <span className="text-xs font-mono text-dim block mb-2">
                {project.period}
              </span>
            ...
            <span className="text-xs px-3 py-1 rounded-full bg-accent/10 text-accent border border-accent/20 shrink-0">
              {project.institution}
            </span>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            <div>
              <h4 className="text-xs tracking-[0.15em] uppercase text-dim mb-3 flex items-center gap-1.5">
          ...
          <div className="flex flex-wrap gap-2 pt-4 border-t border-card-border">
            {project.techStack.map((tech) => (
              <span
                key={tech}
                className="text-xs px-3 py-1 rounded-full bg-white/[0.04] text-muted border border-card-border"
              >
                {tech}
              </span>
            ))}
